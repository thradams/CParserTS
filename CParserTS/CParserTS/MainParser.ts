...
function Parse_Declaration(ctx : Parser) : Result
{
        ...
        token == Tokens.TK_struct)
    {
        ...
        if (result < 2) result = Parse_Declaration_Specifiers(ctx);
        if (result < 2) result = Parse_Init_Declarator_List_Opt(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_SEMICOLON);
    }
    else if (token == Tokens.TK__Static_assert)
    {
        /*Declaration => Static_Assert_Declaration */
        if (result < 2) result = Parse_Static_Assert_Declaration(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Enumeration_Constant(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_identifier)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK_identifier);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Static_Assert_Declaration(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK__Static_assert)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK__Static_assert);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_PARENTHESIS);
        if (result < 2) result = Parse_Constant_Expression(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_COMMA);
        if (result < 2) result = Match(ctx, Tokens.TK_string_literal);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_PARENTHESIS);
        if (result < 2) result = Match(ctx, Tokens.TK_SEMICOLON);
    }
    else
    {
...
function Parse_Type_Specifier(ctx : Parser) : Result
{
    ...
    {
        /*Type_Specifier => void */
        if (result < 2) result = Match(ctx, Tokens.TK_void);
    }
    else if (token == Tokens.TK_char)
    {
        /*Type_Specifier => char */
        if (result < 2) result = Match(ctx, Tokens.TK_char);
    }
    else if (token == Tokens.TK_short)
    {
        /*Type_Specifier => short */
        if (result < 2) result = Match(ctx, Tokens.TK_short);
    }
    else if (token == Tokens.TK_int)
    {
        /*Type_Specifier => int */
        if (result < 2) result = Match(ctx, Tokens.TK_int);
    }
    else if (token == Tokens.TK_long)
    {
        /*Type_Specifier => long */
        if (result < 2) result = Match(ctx, Tokens.TK_long);
    }
    else if (token == Tokens.TK_float)
    {
        /*Type_Specifier => float */
        if (result < 2) result = Match(ctx, Tokens.TK_float);
    }
    else if (token == Tokens.TK_double)
    {
        /*Type_Specifier => double */
        if (result < 2) result = Match(ctx, Tokens.TK_double);
    }
    else if (token == Tokens.TK_signed)
    {
        /*Type_Specifier => signed */
        if (result < 2) result = Match(ctx, Tokens.TK_signed);
    }
    else if (token == Tokens.TK_unsigned)
    {
        /*Type_Specifier => unsigned */
        if (result < 2) result = Match(ctx, Tokens.TK_unsigned);
    }
    else if (token == Tokens.TK__Bool)
    {
        /*Type_Specifier => _Bool */
        if (result < 2) result = Match(ctx, Tokens.TK__Bool);
    }
    else if (token == Tokens.TK__Complex)
    {
        /*Type_Specifier => _Complex */
        if (result < 2) result = Match(ctx, Tokens.TK__Complex);
    }
    else if (token == Tokens.TK__Atomic)
    {
        /*Type_Specifier => Atomic_Type_Specifier */
        if (result < 2) result = Parse_Atomic_Type_Specifier(ctx);
    }
    else if (token == Tokens.TK_union ||
        token == Tokens.TK_struct)
    {
        /*Type_Specifier => Struct_Or_Union_Specifier */
        if (result < 2) result = Parse_Struct_Or_Union_Specifier(ctx);
    }
    else if (token == Tokens.TK_enum)
    {
        /*Type_Specifier => Enum_Specifier */
        if (result < 2) result = Parse_Enum_Specifier(ctx);
    }
    else if (token == Tokens.TK_identifier)
    {
        /*Type_Specifier => Typedef_Name */
        if (result < 2) result = Parse_Typedef_Name(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Type_Qualifier(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_const)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK_const);
    }
    else if (token == Tokens.TK_restrict)
    {
        /*Type_Qualifier => restrict */
        if (result < 2) result = Match(ctx, Tokens.TK_restrict);
    }
    else if (token == Tokens.TK_volatile)
    {
        /*Type_Qualifier => volatile */
        if (result < 2) result = Match(ctx, Tokens.TK_volatile);
    }
    else if (token == Tokens.TK__Atomic)
    {
        /*Type_Qualifier => _Atomic */
        if (result < 2) result = Match(ctx, Tokens.TK__Atomic);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Alignment_Specifier(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK__Alignas)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK__Alignas);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_PARENTHESIS);
        if (result < 2) result = Parse_Type_Name(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_PARENTHESIS);
    }
...
function Parse_Storage_Class_Specifier(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_typedef)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK_typedef);
    }
    else if (token == Tokens.TK_extern)
    {
        /*Storage_Class_Specifier => extern */
        if (result < 2) result = Match(ctx, Tokens.TK_extern);
    }
    else if (token == Tokens.TK_static)
    {
        /*Storage_Class_Specifier => static */
        if (result < 2) result = Match(ctx, Tokens.TK_static);
    }
    else if (token == Tokens.TK__Thread_local)
    {
        /*Storage_Class_Specifier => _Thread_local */
        if (result < 2) result = Match(ctx, Tokens.TK__Thread_local);
    }
    else if (token == Tokens.TK_auto)
    {
        /*Storage_Class_Specifier => auto */
        if (result < 2) result = Match(ctx, Tokens.TK_auto);
    }
    else if (token == Tokens.TK_register)
    {
        /*Storage_Class_Specifier => register */
        if (result < 2) result = Match(ctx, Tokens.TK_register);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Function_Specifier(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_inline)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK_inline);
    }
    else if (token == Tokens.TK__Noreturn)
    {
        /*Function_Specifier => _Noreturn */
        if (result < 2) result = Match(ctx, Tokens.TK__Noreturn);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Init_Declarator_List(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        ...
        if (result < 2) result = Parse_Init_Declarator(ctx);
    }
    else if (token == Tokens.TK_identifier ||
        token == Tokens.TK_EQUALS_SIGN ||
        token == Tokens.TK_COMMA ||
...
function Parse_Declaration_Specifiers(ctx : Parser) : Result
{
        ...
        token == Tokens.TK_register)
    {
        ...
        if (result < 2) result = Parse_Storage_Class_Specifier(ctx);
        if (result < 2) result = Parse_Declaration_SpecifiersOpt(ctx);
    }
    else if (token == Tokens.TK_identifier ||
        token == Tokens.TK__Bool ||
        token == Tokens.TK_short ||
        ...
        token == Tokens.TK_struct)
    {
        ...
        if (result < 2) result = Parse_Type_Specifier(ctx);
        if (result < 2) result = Parse_Declaration_SpecifiersOpt(ctx);
    }
    else if (token == Tokens.TK_const ||
        token == Tokens.TK__Atomic ||
        token == Tokens.TK_restrict ||
        token == Tokens.TK_volatile)
    {
        /*Declaration_Specifiers => Type_Qualifier Declaration_SpecifiersOpt */
        if (result < 2) result = Parse_Type_Qualifier(ctx);
        if (result < 2) result = Parse_Declaration_SpecifiersOpt(ctx);
    }
    else if (token == Tokens.TK__Noreturn ||
        token == Tokens.TK_inline)
    {
        ...
        if (result < 2) result = Parse_Function_Specifier(ctx);
        if (result < 2) result = Parse_Declaration_SpecifiersOpt(ctx);
    }
    else if (token == Tokens.TK__Alignas)
    {
        /*Declaration_Specifiers => Alignment_Specifier Declaration_SpecifiersOpt */
        if (result < 2) result = Parse_Alignment_Specifier(ctx);
        if (result < 2) result = Parse_Declaration_SpecifiersOpt(ctx);
    }
    else
    {
...
function Parse_Declarator(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
    ...
    if (token == Tokens.TK_identifier ||
        ...
        token == Tokens.TK_LEFT_PARENTHESIS ||
        token == Tokens.TK_COLON)
    {
        /*Declarator => PointerOpt Direct_Declarator */
        if (result < 2) result = Parse_PointerOpt(ctx);
        if (result < 2) result = Parse_Direct_Declarator(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Init_Declarator(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        ...
        if (result < 2) result = Parse_Declarator(ctx);
    }
    else if (token == Tokens.TK_identifier ||
        token == Tokens.TK_EQUALS_SIGN ||
        token == Tokens.TK_ASTERISK ||
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        ...
        if (result < 2) result = Parse_Declarator(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_EQUALS_SIGN);
        if (result < 2) result = Parse_Initializer(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Initializer(ctx : Parser) : Result
{
        ...
        token == Tokens.TK_COMMA)
    {
        ...
        if (result < 2) result = Parse_Assignment_Expression(ctx);
    }
    else if (token == Tokens.TK_LEFT_CURLY_BRACKET)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_CURLY_BRACKET);
        if (result < 2) result = Parse_Initializer_List(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_CURLY_BRACKET);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_CURLY_BRACKET);
        if (result < 2) result = Parse_Initializer_List(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_COMMA);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_CURLY_BRACKET);
...
function Parse_Struct_Declaration(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_identifier ||
        ...
        token == Tokens.TK_struct)
    {
        /*Struct_Declaration => Specifier_Qualifier_List Struct_Declarator_ListOpt SEMICOLON */
        if (result < 2) result = Parse_Specifier_Qualifier_List(ctx);
        if (result < 2) result = Parse_Struct_Declarator_ListOpt(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_SEMICOLON);
    }
    else if (token == Tokens.TK__Static_assert)
    {
...
function Parse_Struct_Declaration_List(ctx : Parser) : Result
{
        ...
        token == Tokens.TK_struct)
    {
        ...
        if (result < 2) result = Parse_Struct_Declaration(ctx);
    }
    else if (token == Tokens.TK_identifier ||
        token == Tokens.TK__Bool ||
        token == Tokens.TK_short ||
        ...
        token == Tokens.TK_struct)
    {
        ...
        if (result < 2) result = Parse_Struct_Declaration_List(ctx);
        if (result < 2) result = Parse_Struct_Declaration(ctx);
    }
    else
    {
...
function Parse_Enum_Specifier(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_enum)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK_enum);
        if (result < 2) result = Parse_IdentifierOpt(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_CURLY_BRACKET);
        if (result < 2) result = Parse_Enumerator_List(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_CURLY_BRACKET);
    }
    else if (token == Tokens.TK_enum)
    {
...
function Parse_Specifier_Qualifier_List(ctx : Parser) : Result
{
        ...
        token == Tokens.TK_struct)
    {
        ...
        if (result < 2) result = Parse_Type_Specifier(ctx);
        if (result < 2) result = Parse_Specifier_Qualifier_ListOpt(ctx);
    }
    else if (token == Tokens.TK_const ||
        token == Tokens.TK__Atomic ||
        token == Tokens.TK_restrict ||
...
function Parse_Struct_Declarator_List(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
        ...
        token == Tokens.TK_COLON)
    {
        ...
        if (result < 2) result = Parse_Struct_Declarator(ctx);
    }
    else if (token == Tokens.TK_identifier ||
        token == Tokens.TK_COMMA ||
        token == Tokens.TK_ASTERISK ||
        ...
        token == Tokens.TK_COLON)
    {
        ...
        if (result < 2) result = Parse_Struct_Declarator_List(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_COMMA);
        if (result < 2) result = Parse_Struct_Declarator(ctx);
    }
    else
...
function Parse_Struct_Or_Union(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_struct)
    {
        ...
        if (result < 2) result = Match(ctx, Tokens.TK_struct);
    }
    else if (token == Tokens.TK_union)
    {
        /*Struct_Or_Union => union */
        if (result < 2) result = Match(ctx, Tokens.TK_union);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_PointerOpt(ctx : Parser) : Result
{
    ...
    {
        /*PointerOpt => Pointer */
        if (result < 2) result = Parse_Pointer(ctx);
    }
    else if (token == Tokens.TK_identifier ||
        token == Tokens.TK_LEFT_SQUARE_BRACKET ||
        token == Tokens.TK_LEFT_PARENTHESIS)
...
function Parse_Direct_Declarator(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
    ...
    {
        /*Direct_Declarator => LEFT_PARENTHESIS Declarator RIGHT_PARENTHESIS */
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_PARENTHESIS);
        if (result < 2) result = Parse_Declarator(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_PARENTHESIS);
    }
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        /*Direct_Declarator => Direct_Declarator LEFT_SQUARE_BRACKET Type_Qualifier_ListOpt Assignment_ExpressionOpt RIGHT_SQUARE_BRACKET */
        if (result < 2) result = Parse_Direct_Declarator(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_SQUARE_BRACKET);
        if (result < 2) result = Parse_Type_Qualifier_ListOpt(ctx);
        if (result < 2) result = Parse_Assignment_ExpressionOpt(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_SQUARE_BRACKET);
    }
    else if (token == Tokens.TK_identifier ||
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        /*Direct_Declarator => Direct_Declarator LEFT_SQUARE_BRACKET static Type_Qualifier_ListOpt Assignment_Expression RIGHT_SQUARE_BRACKET */
        if (result < 2) result = Parse_Direct_Declarator(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_SQUARE_BRACKET);
        if (result < 2) result = Match(ctx, Tokens.TK_static);
        if (result < 2) result = Parse_Type_Qualifier_ListOpt(ctx);
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        /*Direct_Declarator => Direct_Declarator LEFT_SQUARE_BRACKET Type_Qualifier_List static Assignment_Expression RIGHT_SQUARE_BRACKET */
        if (result < 2) result = Parse_Direct_Declarator(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_SQUARE_BRACKET);
        if (result < 2) result = Parse_Type_Qualifier_List(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_static);
        if (result < 2) result = Parse_Assignment_Expression(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_SQUARE_BRACKET);
    }
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        /*Direct_Declarator => Direct_Declarator LEFT_SQUARE_BRACKET Type_Qualifier_ListOpt ASTERISK RIGHT_SQUARE_BRACKET */
        if (result < 2) result = Parse_Direct_Declarator(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_LEFT_SQUARE_BRACKET);
        if (result < 2) result = Parse_Type_Qualifier_ListOpt(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_ASTERISK);
        if (result < 2) result = Match(ctx, Tokens.TK_RIGHT_SQUARE_BRACKET);
    }
    else
    {
...
function Parse_Struct_Declarator(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        ...
        token == Tokens.TK_COLON)
    {
        /*Struct_Declarator => DeclaratorOpt COLON Constant_Expression */
        if (result < 2) result = Parse_DeclaratorOpt(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_COLON);
        if (result < 2) result = Parse_Constant_Expression(ctx);
    }
    else
    {
...
function Parse_Parameter_Declaration(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
        ...
        token == Tokens.TK_struct)
    {
        ...
        token == Tokens.TK_struct)
    {
        /*Parameter_Declaration => Declaration_Specifiers Abstract_DeclaratorOpt */
        if (result < 2) result = Parse_Declaration_Specifiers(ctx);
        if (result < 2) result = Parse_Abstract_DeclaratorOpt(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_ParameterList(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
        ...
        token == Tokens.TK_struct)
    {
        ...
        if (result < 2) result = Parse_Parameter_Declaration(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Abstract_DeclaratorOpt(ctx : Parser) : Result
{
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        ...
        if (result < 2) result = Parse_Abstract_Declarator(ctx);
    }
...
function Parse_Identifier_List(ctx : Parser) : Result
{
    var result = RESULT_OK;
    var token = Token(ctx); 
    ...
    else if (token == Tokens.TK_identifier)
    {
        ...
        if (result < 2) result = Parse_Identifier_List(ctx);
        if (result < 2) result = Match(ctx, Tokens.TK_COMMA);
        if (result < 2) result = Match(ctx, Tokens.TK_identifier);
    }
    else
...
function Main_Main(ctx : Parser) : Result
{
    ...
    {
        /*Main => Declaration */
        if (result < 2) result = Parse_Declaration(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Constant_Expression(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_number)
    {
        /*Constant_Expression => number */
        if (result < 2) result = Match(ctx, Tokens.TK_number);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Enumerator_List(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_identifier)
    {
        ...
        if (result < 2) result = Parse_Enumerator(ctx);
    }
    else
    {
        result = RESULT_FAIL;
...
function Parse_Enumerator(ctx : Parser) : Result
{
    ...
    if (token == Tokens.TK_identifier)
    {
        ...
        if (result < 2) result = Parse_Enumeration_Constant(ctx);
    }
    else if (token == Tokens.TK_identifier)
    {
...
function Parse_Abstract_Declarator(ctx : Parser) : Result
{
        ...
        token == Tokens.TK_LEFT_PARENTHESIS)
    {
        ...
        if (result < 2) result = Parse_PointerOpt(ctx);
        if (result < 2) result = Parse_Direct_Abstract_Declarator(ctx);
    }
    else
    {
        result = RESULT_FAIL;
